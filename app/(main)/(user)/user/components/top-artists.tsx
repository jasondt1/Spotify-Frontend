...
import type { TopArtistDto } from "@/dto/artist"
...
export function TopArtists({ artists, limit }: Props) {
      ...
      {displayArtists.map((item) => {
        ...
        return (
          <Link
            ...
            className="group rounded-xl bg-transparent p-4 transition hover:bg-neutral-800"
          >
